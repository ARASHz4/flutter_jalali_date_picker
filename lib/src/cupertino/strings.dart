...
class StringsText {
 ...
 static String datePickerDayOfMonth(int dayIndex) => intl.NumberFormat('', 'fa').format(dayIndex);

  
 static String datePickerHour(int hour) => intl.NumberFormat('', 'fa').format(hour);

  
 static String datePickerHourSemanticsLabel(int hour) => "$hour o'clock";

  
 static String datePickerMinute(int minute) => intl.NumberFormat('', 'fa').format(minute).padLeft(2, '۰');
